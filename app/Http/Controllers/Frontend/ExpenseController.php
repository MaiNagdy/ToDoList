...
class ExpenseController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.expenses.create', compact('employee_names', 'expense_categories', 'salaries', 'salary_commissions'));
    }
    ...
    public function edit(Expense $expense)
    {
        ...
        return view('frontend.expenses.edit', compact('employee_names', 'expense', 'expense_categories', 'salaries', 'salary_commissions'));
    }
