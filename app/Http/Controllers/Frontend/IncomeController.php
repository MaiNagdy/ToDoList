...
class IncomeController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.incomes.create', compact('client_names', 'clients', 'income_categories'));
    }
    ...
    public function edit(Income $income)
    {
        ...
        return view('frontend.incomes.edit', compact('client_names', 'clients', 'income', 'income_categories'));
    }
