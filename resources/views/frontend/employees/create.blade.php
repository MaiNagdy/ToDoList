                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.employees.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="working_name" id="working_name" value="{{ old('working_name', '') }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="working_days" id="working_days" value="1" {{ old('working_days', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="from" id="from" value="{{ old('from') }}">
                            @if($errors->has('from'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('from') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="to" id="to" value="{{ old('to') }}">
                            @if($errors->has('to'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('to') }}
                                </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="working_days_1" id="working_days_1" value="1" {{ old('working_days_1', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="from_1" id="from_1" value="{{ old('from_1') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="to_1" id="to_1" value="{{ old('to_1') }}">
                            @if($errors->has('to_1'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('to_1') }}
                                </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="working_days_2" id="working_days_2" value="1" {{ old('working_days_2', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="from_2" id="from_2" value="{{ old('from_2') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="to_3" id="to_3" value="{{ old('to_3') }}">
                            @if($errors->has('to_3'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('to_3') }}
                                </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="working_day_3" id="working_day_3" value="1" {{ old('working_day_3', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="from_3" id="from_3" value="{{ old('from_3') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="to_4" id="to_4" value="{{ old('to_4') }}">
                            @if($errors->has('to_4'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('to_4') }}
                                </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="working_days_4" id="working_days_4" value="1" {{ old('working_days_4', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="from_4" id="from_4" value="{{ old('from_4') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="to_5" id="to_5" value="{{ old('to_5') }}">
                            @if($errors->has('to_5'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('to_5') }}
                                </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="working_days_5" id="working_days_5" value="1" {{ old('working_days_5', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="from_5" id="from_5" value="{{ old('from_5') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="to_6" id="to_6" value="{{ old('to_6') }}">
                            @if($errors->has('to_6'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('to_6') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="salary" id="salary" value="{{ old('salary', '1000') }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="contract_percentage" id="contract_percentage" value="{{ old('contract_percentage', '0') }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="commission" id="commission" value="{{ old('commission', '') }}" step="0.01" required>
