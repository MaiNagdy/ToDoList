...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-employeeReservations">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.reservation.fields.employee') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($reservations as $key => $reservation)
                        <tr data-entry-id="{{ $reservation->id }}">
                            ...
                            <td>
                                {{ $reservation->course->course_type ?? '' }}
                            </td>
                            <td>
...
@endcan
  ...
  let table = $('.datatable-employeeReservations:not(.ajaxTable)').DataTable({ buttons: dtButtons })
