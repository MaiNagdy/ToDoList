    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.clients.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('written_at') ? 'is-invalid' : '' }}" type="text" name="written_at" id="written_at" value="{{ old('written_at') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telephone') ? 'is-invalid' : '' }}" type="number" name="telephone" id="telephone" value="{{ old('telephone', '0') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Client::COURSE_REQUIRED_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('course_required') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="course_required_{{ $key }}" name="course_required" value="{{ $key }}" {{ old('course_required', '') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('required_training') ? 'is-invalid' : '' }}" type="text" name="required_training" id="required_training" value="{{ old('required_training', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_of_days') ? 'is-invalid' : '' }}" type="number" name="number_of_days" id="number_of_days" value="{{ old('number_of_days', '3') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('remainig_amount') ? 'is-invalid' : '' }}" type="number" name="remainig_amount" id="remainig_amount" value="{{ old('remainig_amount', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Client::LEARN_BEFORE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('learn_before') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="learn_before_{{ $key }}" name="learn_before" value="{{ $key }}" {{ old('learn_before', '') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('where') ? 'is-invalid' : '' }}" type="text" name="where" id="where" value="{{ old('where', '') }}">
                @if($errors->has('where'))
                    <div class="invalid-feedback">
                        {{ $errors->first('where') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('how_you_know_us') ? 'is-invalid' : '' }}" type="text" name="how_you_know_us" id="how_you_know_us" value="{{ old('how_you_know_us', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contract') ? 'is-invalid' : '' }}" type="number" name="contract" id="contract" value="{{ old('contract', '1') }}" step="1" required>
